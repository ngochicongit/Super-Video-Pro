...
Latest gate closure: V1.9.2 local release candidate on 2026-08-27. Verification and installer evidence are recorded in `docs/RELEASE_NOTES_V1.9.2.md`; no external publication is claimed.
