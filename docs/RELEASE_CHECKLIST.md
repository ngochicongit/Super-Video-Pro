...
Latest gate closure: V1.12.0 local release candidate on 2026-08-28. Verification and installer evidence are recorded in `docs/RELEASE_NOTES_V1.12.0.md`; no external publication is claimed.
