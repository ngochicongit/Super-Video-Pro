...
Latest gate closure: V1.12.1 local release candidate on 2026-08-28. Verification and installer evidence are recorded in `docs/RELEASE_NOTES_V1.12.1.md`; no external publication is claimed.
