...
if(process.argv.includes("--certify")){
  const data={schemaVersion:1,certifiedAt:new Date().toISOString(),policy:"Skip repeated manual/real-site/visual certification only while the group fingerprint is unchanged. Always keep pnpm verify in the delivery gate.",validation:{verify:"27 files / 104 tests PASS",directMp4:"PASS",publicHls:"PASS",uiDownload:"PASS, 788493 bytes, no .part",visualTabs:"PASS at 1180x760; V1.3.4 complete evidence gate visual/DOM smoke PASS",productionAudit:"no known vulnerabilities"},groups:current};
