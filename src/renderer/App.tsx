...
export function App(){
  ...
  return <>
    ...
    <main aria-hidden={tasksOpen||settingsOpen||undefined} inert={tasksOpen||settingsOpen||undefined}>
      <AppHeader activeTasks={activeDownloads} onTasks={openTasks} onSettings={openSettings}/>
